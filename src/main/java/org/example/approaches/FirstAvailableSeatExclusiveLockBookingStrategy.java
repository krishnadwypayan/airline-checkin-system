...
public class FirstAvailableSeatExclusiveLockBookingStrategy extends BookingStrategy {
    ...
    protected void bookSeat(int airlineId, int passengerId) {
        try {
            ...
            PreparedStatement statement = connection
                    .prepareStatement("SELECT id from seats WHERE airline_id=? AND passenger_id=0 ORDER BY id LIMIT 1 FOR UPDATE");
